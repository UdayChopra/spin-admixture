...
parser.add_argument("-v", "--verbose", dest="v", action="store_true",\
	help="Print cummulative gamma2 ")

args = parser.parse_args()
outfilename = os.path.splitext(args.movecsfile)[0]

m      = nwcparse.read(args.movecsfile)
ha     = m.homo_index[0]
...
# Transforming basis of H_soc from cartesian to |n,l,m,s>
...
# Deleting the ha row-vector (perturbation theory doesn't loop over it)
